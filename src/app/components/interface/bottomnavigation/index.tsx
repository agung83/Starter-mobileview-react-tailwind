...
interface TypePropsRouter extends NavLinkProps {
    to: string,
    isActive?: any,
    children?: JSX.Element | JSX.Element[]
}

const CustomNavLink = (props: TypePropsRouter) => <NavLink {...props} />
...
export function BottomNav() {
    ...
    // const klik = () => {
    //     router.push({
    //         pathname: router.route.about,
    //         search: '?page=home122&agung=laksmana',
    //         state: { page: 'mami', monica: 'sari' }
    //     })
    // }
        ...
        <div className="w-full h-full">
            <section id="bottom-navigation" className="block fixed inset-x-0 bottom-0 z-10 bg-white shadow-lg">
                <div id="tabs" className="flex justify-center">
                    <CustomNavLink exact activeClassName="text-blue-800" to={router.route.home} className="w-28 text-gray-600 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1">
                        <svg width="25" height="25" viewBox="0 0 42 42" className="inline-block mb-1 hover:text-gray-400">
                    ...
                    <CustomNavLink
                        exact activeClassName="text-blue-800"
                        className="w-28 text-gray-600 justify-center inline-block text-center pt-2 pb-1" to={router.route.about}
                    >
                    ...
                    <a href="#" className="w-28 text-gray-600  justify-center inline-block text-center pt-2 pb-1">
                        <svg width="25" height="25" viewBox="0 0 42 42" className="inline-block mb-1 hover:text-red-300">
                            <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
