        ...
        <div className="w-full h-full">
            <section id="bottom-navigation" className="block fixed inset-x-0 bottom-0 z-10 bg-white shadow-lg">
                <div id="tabs" className="flex justify-center">
                    <NavLink exact activeClassName="text-blue-800" to={router.route.home} className="w-28 text-gray-600 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1">
                    ...
                    <NavLink exact activeClassName="text-blue-800" className="w-28 text-gray-600 justify-center inline-block text-center pt-2 pb-1" to={router.route.about}>
